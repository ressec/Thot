 ...
 * ---------------------------------------------------------------------------
 */
package org.heliosphere.thot.hazelcast.test.persistence.h2;
...
/**
 * A test unit case for the {@link BerkeleyStoreMap}.
 * <hr>
 * @author Resse Christophe, Heliosphere Corp. 2012-2013
 * @version 1.0.0
 */
public final class MapPersistenceTest
{
	...
	/**
	 * Tests the persistence of some records in the 'default' map ; i.e.
